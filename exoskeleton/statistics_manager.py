...
class StatisticsManager:
    ...
    def num_tasks_wo_errors(self) -> int:
        ...
        with self.db_connection.session_scope() as session:
            return session.query(models.Queue).filter(
    ...
    def num_tasks_w_permanent_errors(self) -> int:
        ...
        with self.db_connection.session_scope() as session:
            return session.query(models.Queue).join(
                models.ErrorType,
    ...
    def __update_host_statistics(
        ...
        with self.db_connection.session_scope() as session:
            host_stats = session.query(models.StatisticsHost).filter(
            ...
            if host_stats:
                ...
                host_stats.permamentErrors += (  # type: ignore[assignment]
                    permanent_errors_increment)
                host_stats.hitRateLimit += (  # type: ignore[assignment]
